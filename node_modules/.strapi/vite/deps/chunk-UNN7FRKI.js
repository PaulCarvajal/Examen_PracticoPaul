...
} from "./chunk-R6YWD3ZG.js";
import {
  QueryClient,
  QueryClientProvider,
  img
} from "./chunk-DTIN3GYT.js";
import {
...
import {
  require_pick
} from "./chunk-3CEAFMMH.js";
import {
  useEnterprise
} from "./chunk-FSSGMKUQ.js";
import {
  GuidedTourProvider,
  useGuidedTour
} from "./chunk-UOSXIDLH.js";
import {
  Login
} from "./chunk-6NXWXHG2.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-F6C27QAE.js";
import {
  ConfigurationProvider
} from "./chunk-MB5CC3EV.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-422R6PF3.js";
import {
  require_baseRest
} from "./chunk-GS36V65H.js";
import {
  HistoryProvider
} from "./chunk-2Y6WBIGG.js";
import {
  TrackingProvider,
  useTracking
} from "./chunk-A5ZI6KS3.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-TTTBHKFG.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-YULPXZQX.js";
import {
  ADMIN_PERMISSIONS_EE,
  getEERoutes
} from "./chunk-TG5CCE6A.js";
import {
  errorsTrads
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-UPSBVDV5.js";
import {
  MemoizedInputRenderer
} from "./chunk-CAY54DBL.js";
import {
  Form
} from "./chunk-XLJ6YM7A.js";
import {
  Layouts
} from "./chunk-UWQGOJSU.js";
import {
  getByteSize
...
} from "./chunk-MC6UK4MU.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-ZP2GSSVN.js";
import {
  NotificationsProvider,
  useNotification
} from "./chunk-LDQUDX2M.js";
import {
  adminApi,
  getFetchClient,
  isBaseQueryError,
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-E2QD5L6J.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-BUA2NPRW.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-KN6X6CWQ.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-E64TBNR5.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-7OQUY4NR.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-IEMM222H.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-FO6HM4RH.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-GIC6IA3O.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-X6LOFHNW.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-6UMWIQOV.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-UGWR7H2S.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-CFSVZ4RJ.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-HKJOYAOF.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-D3YUCLU5.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-ITENRSCK.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-NQSGYYKZ.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-ED6ZJ2XI.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-6M55SIEY.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-CXQFS3AE.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-TUX74L3J.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-GWSI5KFL.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-FJ473SKJ.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-AUVISOUO.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-QV2WLGDM.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-7NBGYMPP.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-HZ3NHX2D.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-KPLVPLSD.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-5TLPSB3Y.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-HMZMPI53.js");
              return {
...
//# sourceMappingURL=chunk-UNN7FRKI.js.map
